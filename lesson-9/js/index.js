...
function Coffee(size,isDecaf,qtyCream,qtySugar){
    ...
    this.description = function(){
        output.textContent = `A ${this.size} ${(this.Decaf === true?"decaffeinated":"caffeinated")} coffee with ${this.qtyCream} creams and ${this.qtySugar} teaspoons of sugar`;
    }
}
/* STEP 2: Instatiate a coffee based on the above constructor function */
let scottsCoffee = new Coffee("extra large",false,1,1);
